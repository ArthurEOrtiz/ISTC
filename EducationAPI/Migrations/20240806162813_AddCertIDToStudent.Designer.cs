...
namespace EducationAPI.Migrations
{
    ...
    [Migration("20240806162813_AddCertIDToStudent")]
    partial class AddCertIDToStudent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationAPI.Models.Certification", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("CertificationsHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("EducationAPI.Models.Student", b =>
                {
                    ...
                    b.Property<int?>("AppraisalCertId")
                        .HasColumnType("int");

                    b.Property<bool>("AppraisalCertified")
                        .HasColumnType("bit");

                    b.Property<int?>("MappingCertId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EducationAPI.Models.Certification", b =>
                {
                    b.HasOne("EducationAPI.Models.Student", null)
