...
import { Course, CourseStatus, Topic, User } from "@/Utilities/sharedTypes";
import { GetUserByClerkId, getAllTopics, GetCourses } from "@/Utilities/api";
import ErrorModel from "@/components/modals/ErrorModal";
...
const CourseCatalog: React.FC<CourseCatalogProps> = ({isAdmin = false, sendEmail}) => {
    ...
    const handleSearchOnChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (userInput === '') {
            getCourses(selectedStatuses, selectedTopics.map(topic => topic.topicId), "");
            setSearchString('');
        } else {
